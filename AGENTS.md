...
- For Android 12+ GPU/OpenCL tests, preserve optional `<uses-native-library>` declarations for vendor OpenCL/GPU libraries in the app manifest unless a device log proves they are harmful.
